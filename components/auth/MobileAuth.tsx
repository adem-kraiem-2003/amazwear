...
export default function MobileAuth() {
  ...
  return (
    <main className="flex-1 flex flex-col items-center justify-center px-margin-mobile py-16 font-body-md min-h-dvh">
      <header className="w-full flex justify-center mb-12">
        <Link href="/" className="font-display-lg-mobile text-display-lg-mobile text-primary hover:opacity-70 transition-opacity">
          LUXE
        </Link>
      </header>
          ...
          <div>
            <form onSubmit={handleSignIn} className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <label className="font-label-sm text-label-sm text-secondary uppercase tracking-widest" htmlFor="m-signin-email">
                  Email Address
                </label>
                <input
                  id="m-signin-email"
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-baseline">
                  <label className="font-label-sm text-label-sm text-secondary uppercase tracking-widest" htmlFor="m-signin-pw">
                    Password
                  </label>
        ...
        {tab === "register" && (
          <div>
            <form onSubmit={handleRegister} className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <label className="font-label-sm text-label-sm text-secondary uppercase tracking-widest" htmlFor="m-reg-name">
                  Full Name
                </label>
                <input
                  id="m-reg-name"
              ...
              <div className="flex flex-col gap-2">
                <label className="font-label-sm text-label-sm text-secondary uppercase tracking-widest" htmlFor="m-reg-email">
                  Email Address
                </label>
                <input
                  id="m-reg-email"
              ...
              <div className="flex flex-col gap-2">
                <label className="font-label-sm text-label-sm text-secondary uppercase tracking-widest" htmlFor="m-reg-pw">
                  Password
                </label>
                <input
                  id="m-reg-pw"
